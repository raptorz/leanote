...
INSERT INTO public.configs (id, user_id, key, value_str, value_arr, value_map, value_arr_map, is_arr, is_map, is_arr_map, updated_time) VALUES ('5437e78a99c37bbad4000002', '5368c1aa99c37b029d000001', 'demoUsername', 'demo@gemsnote.com', '{}', '{}', '[]', false, false, false, '2014-10-22 11:53:56.313+00') ON CONFLICT DO NOTHING;
INSERT INTO public.configs (id, user_id, key, value_str, value_arr, value_map, value_arr_map, is_arr, is_map, is_arr_map, updated_time) VALUES ('5437e78a99c37bbad4000003', '5368c1aa99c37b029d000001', 'demoPassword', 'demo@gemsnote.com', '{}', '{}', '[]', false, false, false, '2014-10-22 11:53:56.314+00') ON CONFLICT DO NOTHING;
...
INSERT INTO public.users (id, email, verified, username, username_raw, pwd, created_time, logo, theme, notebook_width, note_list_width, md_editor_width, left_is_min, third_user_id, third_username, third_type, image_num, image_size, attach_num, attach_size, from_user_id, account_type, account_start_time, account_end_time, max_image_nums, max_image_size, max_attach_num, max_attach_size, max_per_attach_size, usn, full_sync_before) VALUES ('540817e099c37b583c000001', 'demo@gemsnote.com', false, 'demo', 'demo', '84e724109bd30a935846e8302be01bd8', '2014-09-04 07:42:24.064+00', '', '', 0, 0, 0, false, '', '', 0, 0, 0, 0, 0, NULL, '', NULL, NULL, 0, 0, 0, 0, 0, 200006, NULL) ON CONFLICT DO NOTHING;
